...
public class Main {
	...
	public static void ejemploList(String[] args) {
	...
	public static void ejemploSet(String[] args) {
	...
	public static void ejemploQueue(String[] args) {
	...
	public static void ejemploDeque(String[] args) {
	...
	public static void ejemploMap(String[] args) {
	...
	public static void ejemploSort(String[] args) {
	...
	public static void ejemploReverse(String[] args) {
	...
	public static void ejemploShuffle(String[] args) {
	...
	public static void ejemploSwap(String[] args) {
	...
	public static void ejemploFill(String[] args) {
